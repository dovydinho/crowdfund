...
const Arrow = (type: string, onClick: any) => {
  const pointer =
    type == 'PREV' ? (
  ...
  return (
    <button onClick={onClick}>
      <span className="grid items-center w-10 h-10 border bg-gray-100/10 border-gray-100/5 hover:bg-gray-100/20 transition-all px-2">
        {pointer}
      </span>
    </button>
  );
